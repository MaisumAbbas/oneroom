...
var HomeComponent = /*#__PURE__*/function () {
  ...
  (0,D_MainProjects_or_oneroom_frontend_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(HomeComponent, [{
    ...
    value: function getLocation1() {
      ...
      if (window.location.protocol == "https:" && navigator.geolocation) navigator.geolocation.getCurrentPosition(function (position) {
        alert(); // geolocation["lat"] = position.coords.latitude;
    ...
    value: function getLocation() {
      this.getLocation1();
      this.getPosition(); // let geolocation = navigator.geolocation;
      // if (geolocation) {
    ...
    value: function showPosition(position) {
      alert(); // x.innerHTML = "Latitude: " + position.coords.latitude + 
    ...
    value: function searchResults(data) {
      ...
      this.dataService.post('search', data).then(function (result) {
        ...
        localStorage.setItem('data', JSON.stringify(result.data[data['destination']]));

        _this5.cdf.detectChanges();

        _this5.router.navigate(['guest/searchresult']);
      });
    }
  }, {
    key: "delete",
